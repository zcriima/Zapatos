...
const baseMessage = "Hola, quiero información sobre estos zapatos";

const products = [
{ id:1, name:"Zapato Mujer 1", category:"Mujer", price:"$40", image:"images/mujer1.jpg"},
{ id:2, name:"Zapato Mujer 2", category:"Mujer", price:"$45", image:"images/mujer2.jpg"},
...
document.getElementById("whatsappHeader").href = waLink(baseMessage);
document.getElementById("whatsappFloat").href = waLink(baseMessage);
...
class="block text-center bg-black text-white mt-3 py-2 rounded-xl">
